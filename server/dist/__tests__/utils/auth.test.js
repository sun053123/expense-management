...
describe("AuthUtils", () => {
    ...
    describe("generateToken", () => {
        it("should generate a JWT token", () => {
            ...
            }), process.env.JWT_SECRET, expect.objectContaining({
    ...
    describe("verifyToken", () => {
        it("should verify a valid token", () => {
            ...
            expect(mockedJwt.verify).toHaveBeenCalledWith(token, process.env.JWT_SECRET, expect.objectContaining({
                issuer: "expense-management-api",
                audience: "expense-management-client",
            }));
    ...
    describe("isValidEmail", () => {
        ...
        it("should return false for invalid email", () => {
            ...
            expect(auth_1.AuthUtils.isValidEmail("")).toBe(false);
        });
    });
    describe("isValidPassword", () => {
        it("should return valid for good password", () => {
            ...
            const result = auth_1.AuthUtils.isValidPassword("GoodPass123");
        ...
        it("should return invalid for password without requirements", () => {
            const result = auth_1.AuthUtils.isValidPassword("goodpassword"); // no uppercase or number
            expect(result.valid).toBe(false);
            expect(result.message).toContain("at least one lowercase letter, one uppercase letter, and one number");
        });
